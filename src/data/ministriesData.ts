...
export const MINISTRIES_DATA: Ministry[] = [
  {
    ...
    schedule: 'Sundays at 9:00 AM (During Worship Sermon time) & 8:00 AM Sunday School',
  ...
  },
  {
    ...
    schedule: 'Sundays at 8:00 AM (Sunday School) & Monthly Friday Game Nights',
  ...
  },
  {
    ...
    schedule: 'Saturdays at 2:00 PM – 4:30 PM & Sunday Morning Discipleship',
  ...
  },
  {
    ...
    schedule: 'Every Saturday at 3:00 PM – 6:00 PM',
  ...
  },
  {
    ...
    schedule: 'Bi-Weekly Friday Dinners at 7:00 PM & Sunday 8:00 AM Life Groups',
  ...
  },
  {
    ...
    schedule: 'Sundays at 8:00 AM (Sunday School) & Monthly Couples/Men/Women Circles',
  ...
  },
  {
    ...
    schedule: 'Every 2nd & 4th Thursday at 9:30 AM – 11:30 AM',
