    ...
    <section id="location" className="py-20 bg-dpc-navy-950 px-4 sm:px-6 lg:px-8 relative border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 glass-panel-gold rounded-3xl p-5 sm:p-7 md:p-8 flex flex-col justify-between border-dpc-gold-500/40 shadow-2xl">
            <div className="space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <p className="text-[11px] sm:text-xs text-slate-400 mt-1 italic">
              ...
              <div className="pt-3 border-t border-white/10 space-y-2.5">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 xs:grid-cols-2 gap-2">
                    ...
                    >
                      <svg className="w-4 h-4 fill-current text-[#0084FF] shrink-0" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-2 w-full py-2 px-3 rounded-lg bg-blue-600/10 hover:bg-blue-600/20 border border-blue-500/20 flex items-center justify-center gap-2 text-[11px] font-medium text-blue-300 hover:text-white transition-colors"
                  >
