...
const CHURCH_EVENT_STREAM_IMAGES: StreamImage[] = [
  {
    ...
    alt: 'Camarines Norte Youth Camp 2026 Worship Gathering',
  },
  {
    src: 'https://images.unsplash.com/photo-1438232992991-995b7058bbb3?q=80&w=1200&auto=format&fit=crop',
    alt: 'Lord\'s Day Divine Worship Service at Main Sanctuary',
  },
  {
  ...
  },
  {
    ...
    alt: 'CNYC Sunday School & Youth Discipleship Classrooms',
  },
  {
    ...
    <section id="events" className="py-16 sm:py-20 bg-gradient-to-b from-dpc-navy-950 via-dpc-navy-900 to-dpc-navy-950 relative overflow-hidden">
      ...
      <div className="w-full relative overflow-hidden">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-dpc-navy-950 via-dpc-navy-950/40 to-dpc-navy-950/80 pointer-events-none z-0"></div>
          <div className="absolute inset-y-0 left-0 w-24 sm:w-40 bg-gradient-to-r from-dpc-navy-950 to-transparent pointer-events-none z-0"></div>
          <div className="absolute inset-y-0 right-0 w-24 sm:w-40 bg-gradient-to-l from-dpc-navy-950 to-transparent pointer-events-none z-0"></div>

          {/* Centered Overlay Content */}
          <div className="relative z-10 flex h-full flex-col items-center justify-center py-8 sm:py-12 text-center px-4 sm:px-6 max-w-4xl mx-auto">
            {/* Title & Tagline */}
            <div className="space-y-3 sm:space-y-4">
              <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold font-serif text-white tracking-tight drop-shadow-2xl">
                Witness God’s Faithfulness <br className="hidden sm:inline" />
                <span className="gold-shimmer">In Motion</span>
              </h2>
              <p className="text-xs sm:text-sm md:text-base text-slate-200 max-w-2xl mx-auto font-light leading-relaxed drop-shadow-lg">
                Mula sa kabataang nag-aalab sa Bagasbas Campsite, masinsinang theological seminars, hanggang sa medical missions sa komunidad ng Daet.
              </p>
            </div>
          </div>
        </ImageStreamHero>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-14 sm:mt-18">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-dpc-gold-500/10 border border-dpc-gold-500/30 text-xs font-semibold uppercase tracking-wider text-dpc-gold-400 mb-3">
              ...
              <span>Church Life & Calendar</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredEvents.map((event) => (
            <div
              key={event.id}
              className={`rounded-3xl p-6 sm:p-7 flex flex-col justify-between transition-all duration-300 relative group overflow-hidden ${
                event.featured
